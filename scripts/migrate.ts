...
/**
 * Migration helper script (TypeScript)
 * Applies schema changes to database and creates migrations
 * 
 * Usage: npx tsx scripts/migrate.ts [optional-message]
 * 
 * Examples:
 *   npx tsx scripts/migrate.ts                    // Apply schema changes
 *   npx tsx scripts/migrate.ts "remove activity"  // Apply with description
 */
